...
def gen_api_init_files(
        ...
        output_package = "tensorflow_estimator.python.api",
        package = "tensorflow_estimator.python",
        package_dep = "//tensorflow_estimator/python:estimator_py",
        srcs = [],
        api_name = "estimator"):
    ...
    native.py_binary(
        ...
        srcs = ["//tensorflow_estimator/python/api:create_python_api_wrapper.py"],
        main = "//tensorflow_estimator/python/api:create_python_api_wrapper.py",
