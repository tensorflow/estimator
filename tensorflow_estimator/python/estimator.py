...
from tensorflow_estimator.python import util as estimator_util
from tensorflow_estimator.python.export import export as export_helpers
...
estimator_export(
    'estimator.VocabInfo',
    # This use of overrides is a hack. This is needed because tf.keras still
    # imports tensorflow.python.estimator.estimator which means both this module
    # and tensorflow.python.estimator.estimator are imported so estimator_export
    # is called on VocabInfo symbol twice. This will remain the case until
    # estimator code is completely deleted from TensorFlow. This hack will be
    # deleted at the same time. This hack will allow the tests in this package
    # to pass in the interum.
    overrides=[VocabInfo])(VocabInfo)
